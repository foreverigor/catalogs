...
abstract class AbstractAlias<B : AliasBuilder<T,*>, T : DependencyAlias> constructor(val name: String,
            protected val version: DepVersion,
            private val catalogMap: MutableMap<VersionCatalog, T>? = null) : DependencyAlias {
